                    ...
                    <div class="card-body">
                        <div class="d-flex align-item-center">
                            <button type="submit" class="btn btn-primary px-3 w-100"><ion-icon
                                    name="duplicate-sharp"></ion-icon>Edit</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" value="{{ old('slug', $blog->slug) }}" readonly>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="editor">
                                        <textarea id="summernote" name="kontent" required>{{ old('kontent', $blog->content) }}</textarea>
                                    </div>
                                    @error('kontent')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-4 mt-2 mb-4">
                                        <img src="{{ Storage::url($blog->image) }}" class="img-thumbnail" alt="Preview"
                                    ...
                                    <div class="col-md-12 p-0">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('kategori') is-invalid @enderror"
                                                ...
                                                @foreach ($kategori as $kat)
                                                    <option value="{{ $kat->id }}"
                                                        {{ $kat->id == $blog->id_kategori ? 'selected' : '' }}>
                                                        {{ $kat->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('kategori')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                                ...
                                                <option value="unpublish"
                                                    {{ $blog->status == 'unpublish' ? 'selected' : '' }}>Unpublish</option>
                                                <option value="trash" {{ $blog->status == 'trash' ? 'selected' : '' }}>
                                                    Trash</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="tag" name="tag[]" multiple>
                                                @foreach ($tag as $t)
                                                    <option value="{{ $t->id }}"
                                                        {{ in_array($t->id, $selectedTags) ? 'selected' : '' }}>
                                                        {{ $t->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('tag')
