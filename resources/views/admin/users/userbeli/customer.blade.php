...
@section('content')
                                    ...
                                    <tr class="text-center ">
                                        ...
                                        <td>
                                            <div
                                                ...
                                                @if ($institusi->contains('id_admin', $data->id_admin))
                                                    <a href="{{ route('customer.view', $data->id_admin) }}"
                                                        class="text-primary">
                                                        <i class="fa-solid fa-eye"></i>
                                                    </a>
                                                @else
                                                    <a href="javascript:;" onclick="confirmCek('{{ $data->nama }}')"
                                                        class="text-warning">
    ...
    <script>
        function confirmCek(nama) {
            Swal.fire({
                title: 'User Belum Registrasi Institusi!',
                text: "User " + nama + " belum mendaftarkan institusi dan belum membeli paket!",
                icon: 'warning',
